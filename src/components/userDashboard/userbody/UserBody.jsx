...
//     {/* First Div: List of Name, Phone Number, and Address */}
//     <div className="bg-white p-6 rounded-lg -mt-4 -ml-4 shadow-md">
...
//     {/* Second Div: Account Details */}
//     <div className="bg-white p-6 rounded-lg shadow-md">
//       <h2 className="text-xl font-bold mb-4">Account Details</h2>
//       <p className="text-gray-700">
//         Welcome to your account dashboard. Here you can manage your profile, settings, and
//         more.
//       </p>
//     </div>
    ...
    return (
        ...
        <div className="flex -mt-1 w-full">
          ...
          <div className="w-1/4 bg-white shadow-md p-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 text-gray-600 hover:bg-gray-100 p-3 rounded-lg">
                <FaUser />
     ...
     <StyledWrappere>
      <div className="card">
        ...
        <span className='text-base font-medium'> Skills</span> : JS , PYTHON , C  ,JAVA , HTML  &nbsp; &nbsp; , REACT , NODE, EXPREES ,MOGODB
         <br/>
         </h1>
          <div className="icons">
